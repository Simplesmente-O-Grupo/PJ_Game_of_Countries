...
int initializeCountryList(Card **cards)
{
	*cards = malloc(sizeof(Card) * GLOBAL_COUNTRIES_AMOUNT);
	...
	(*cards)[0] = createCard(1, "Brazil", "America", 85, 76, 92, 77);
	(*cards)[1] = createCard(2, "Germany", "Europe", 90, 95, 87, 77);
	(*cards)[2] = createCard(3, "China", "Asia", 94, 85, 98, 77);
	(*cards)[3] = createCard(4, "Australia", "Oceania", 87, 82, 79, 77);
	(*cards)[4] = createCard(5, "Canada", "America", 89, 91, 84, 77);
	(*cards)[5] = createCard(6, "India", "Asia", 99, 29, 84, 77);
	(*cards)[6] = createCard(7, "France", "Europe", 99, 93, 85, 77);
