...
game: main.o ui_utils.o game_setup.o main_menu.o player.o player_list.o deck.o card.o credits.o fake_loading.o
...
credits.o: src/screens/credits.c src/screens/../include/game_data.h src/screens/../include/player_list.h src/screens/../include/deck.h src/screens/../include/card.h src/screens/../include/player.h
	$(CC) -c -o $@ ${CFLAGS} $< ${LINKER_FLAGS}
fake_loading.o: src/screens/fake_loading.c
	$(CC) -c -o $@ ${CFLAGS} $< ${LINKER_FLAGS}
clean:
	rm -v game main.o ui_utils.o game_setup.o main_menu.o player.o player_list.o deck.o card.o credits.o fake_loading.o
